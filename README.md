...
└── UnityProject/          # Unity sample project
```
...
_It's not a docker project for now, but it should be later..._
...
make install              # Windows without make? run scripts/install-windows.bat instead
```
...
You can also execute the main module directly during development:

```bash
python -m pywui.main --help
```
...
- ![image](https://github.com/mathis-lambert/Python-Yolo-Wrapper-for-Unity-interactions/assets/93223257/961683fb-3a5c-4ae8-b1d1-efb04767c28b)
...
- Click on the play button
- You should see as many articulation groups as people detected by the python script and the articulations should move to the position of the people detected
- ![image](https://github.com/mathis-lambert/Python-Yolo-Wrapper-for-Unity-interactions/assets/93223257/4295744c-4853-4afc-8dc1-295cd1d97f3a)
